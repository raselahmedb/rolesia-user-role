package com.raselahmedb.rolesia.role.security.oauth2;
...
import com.raselahmedb.rolesia.role.security.CustomUserDetails;
import com.raselahmedb.rolesia.role.security.WebSecurityConfig;
...
public class CustomOAuth2UserService extends DefaultOAuth2UserService {
    ...
    private User upsertUser(CustomUserDetails customUserDetails) {
        ...
        if (userOptional.isEmpty()) {
            ...
            user.setRole(new Role(2L, "User", null, Hierarchy.USER));
        } else {
